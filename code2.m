...
path='E:\astra-2.0.0-matlab-win-x64\astra-2.0.0';% here put your data path
savepath = 'F:\Research\Matlab Codes\Data'% here put where you want to store the reconstruciton data
